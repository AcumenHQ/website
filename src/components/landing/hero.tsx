    ...
    <section className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center min-h-[75vh]">
      <div className="lg:col-span-7 space-y-8 animate-clip-in">
        ...
        <div className="pt-4">
          <a
            href="#waitlist"
            className="inline-flex h-12 px-8 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-medium text-sm transition-all shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_30px_rgba(79,70,229,0.5)] items-center justify-center gap-2"
          >
            Join Waitlist
